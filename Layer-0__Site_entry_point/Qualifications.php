...
require_once "../Layer-2__Business_logic/content/forms/Qualifications_form.php";
$qualificationsForm = new QualificationsForm();

$webPage = new WebPage($resourcesTheme,$qualificationsForm);
$webPage->processPage();
$webPage->printPage();
?>
