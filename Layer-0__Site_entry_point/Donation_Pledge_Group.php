...
require_once "../Layer-2__Business_logic/content/forms/Donation_Pledge_Group_form.php";

$donationPledgeGroupForm = new DonationPledgeGroupForm();

$webPage = new WebPage($donationPledgeGroupForm);
$webPage->processPage();
$webPage->printPage();
?>
