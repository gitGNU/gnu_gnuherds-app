...
require_once "../Layer-2__Business_logic/content/forms/Manage_Job_Offer_Applications_form.php";
$manageJobOfferApplicationsForm = new ManageJobOfferApplicationsForm();

$webPage = new WebPage($resourcesTheme,$manageJobOfferApplicationsForm);
$webPage->processPage();
$webPage->printPage();
?>
