...
<img src="/themes/red_Danijel/icons/{if $checkresults.profiles_etc eq 'pass'}green{else}red{/if}-{if $section eq 'profiles_etc'}light{else}dark{/if}.png" alt="{t}{if $checkresults.profiles_etc eq 'pass'}green{else}red{/if}{/t}"><br>
...
<img src="/themes/red_Danijel/icons/{if $checkresults.skills eq 'pass'}green{else}red{/if}-{if $section eq 'skills'}light{else}dark{/if}.png" alt="{t}{if $checkresults.skills eq 'pass'}green{else}red{/if}{/t}"><br>
...
<img src="/themes/red_Danijel/icons/{if $checkresults.languages eq 'pass'}green{else}red{/if}-{if $section eq 'languages'}light{else}dark{/if}.png" alt="{t}{if $checkresults.languages eq 'pass'}green{else}red{/if}{/t}"><br>
...
<img src="/themes/red_Danijel/icons/{if $checkresults.certifications eq 'pass'}green{else}red{/if}-{if $section eq 'certifications'}light{else}dark{/if}.png" alt="{t}{if $checkresults.certifications eq 'pass'}green{else}red{/if}{/t}"><br>
...
<img src="/themes/red_Danijel/icons/{if $checkresults.projects eq 'pass'}green{else}red{/if}-{if $section eq 'projects'}light{else}dark{/if}.png" alt="{t}{if $checkresults.projects eq 'pass'}green{else}red{/if}{/t}"><br>
...
<img src="/themes/red_Danijel/icons/{if $checkresults.location eq 'pass'}green{else}red{/if}-{if $section eq 'location'}light{else}dark{/if}.png" alt="{t}{if $checkresults.location eq 'pass'}green{else}red{/if}{/t}"><br>
...
<img src="/themes/red_Danijel/icons/{if $checkresults.contract eq 'pass'}green{else}red{/if}-{if $section eq 'contract'}light{else}dark{/if}.png" alt="{t}{if $checkresults.contract eq 'pass'}green{else}red{/if}{/t}"><br>
