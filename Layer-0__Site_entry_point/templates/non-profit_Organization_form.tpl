...
<tr align="center"> <td colspan="4" align="center"><h3>{t}Register non-profit organization{/t}</h3></td> </tr>
{/if}

{if $smarty.session.Logged == '1' }
<tr align="center"> <td colspan="4" align="center" class="mainsection">{t}Update non-profit organization{/t}</td> </tr>
{/if}
