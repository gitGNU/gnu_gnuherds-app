...
<form name="nonprofitForm" method="post" action="non-profit_Organization.php">

<table align="center">

{if $smarty.session.Logged != '1' }
<tr align="center"> <td colspan="2" align="center" class="mainsection">{t}NEW NONPROFIT ORGANIZATION{/t}</td> </tr>
<tr> <td colspan="2">&nbsp;</td> </tr>
{/if}

{if $smarty.session.Logged == '1' }
<tr align="center"> <td colspan="2" align="center" class="mainsection">{t}UPDATE NONPROFIT ORGANIZATION{/t}</td> </tr>
<tr> <td colspan="2">&nbsp;</td> </tr>
{/if}
