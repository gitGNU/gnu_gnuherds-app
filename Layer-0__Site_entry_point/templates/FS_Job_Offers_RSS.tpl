...
&amp;nbsp;&amp;nbsp; &lt;B&gt;&lt;FONT COLOR=&quot;#5F9EA0&quot;&gt;{t}Offered by{/t}:&lt;/FONT&gt;&lt;/B&gt; &lt;B&gt;&lt;FONT COLOR=&quot;#BC8F8F&quot;&gt;{if $EP_FirstName[$i]}{t}Person{/t}: {/if}{if $EC_CooperativeName[$i]}{t}Cooperative{/t}: {/if}{if $EC_CompanyName[$i]}{t}Company{/t}: {/if}{if $EO_OrganizationName[$i]}{t}non-profit Organization{/t}: {/if}&lt;/FONT&gt;&lt;/B&gt;&lt;FONT COLOR=&quot;#B8860B&quot;&gt;{if $EP_FirstName[$i]}{$EP_LastName[$i]}{if $EP_LastName[$i] and ($EP_FirstName[$i] or $EP_MiddleName[$i])},{/if}{if $EP_FirstName[$i]} {$EP_FirstName[$i]}{/if}{if $EP_MiddleName} {$EP_MiddleName[$i]}{/if}{/if}{if $EC_CooperativeName[$i]}{$EC_CooperativeName[$i]}{/if}{if $EC_CompanyName[$i]}{$EC_CompanyName[$i]}{/if}{if $EO_OrganizationName[$i]}{$EO_OrganizationName[$i]}{/if}&lt;/FONT&gt;
