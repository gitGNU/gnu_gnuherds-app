...
{t}There are several projects which try to solve the e-Voting trouble. The goal of each project can be different. Some of them has modified its aims or are stalled:{/t}
	<ul>
		<li><a href="http://www.gnu.org/software/free/" target="_blank">GNU.FREE</a>: {t}The development has been discontinued due to{/t} <i>"creating an Internet Voting system sufficiently secure, reliable and anonymous is extremely difficult, if not impossible"</i>.
		</li>
...
<p>
{t escape='no'
  1='<i><a href="http://lwn.net/Articles/44077/" target="_blank">'
  2='</a></i>'
  3='<a href="http://lwn.net/" target="_blank">'
  4='</a>'
...
<ol>
	...
	<li>[Central server] &nbsp; <a href="http://www.gnu.org/software/free/" target="_blank">GNU.FREE</a> &nbsp; <b>(State:&nbsp;REJECTED&nbsp;?&nbsp;)</b>
...
<li>
	<a href="http://www.thebell.net/papers/vote-req.pdf" target="_blank">Voting System Requirements</a>.
...
<li>
	<a href="http://www.gnu.org/software/free/" target="_blank">GNU.FREE links</a>. {t}We want remark:{/t}<br>
	<!-- &nbsp; &nbsp; <a href="http://www.votehere.net/products.htm" target="_blank">E-voting Solutions</a> The list of requirements of the above reference can be useful to check any design. Anyway, we think the "<i>Revisability: A voter can change their vote in a given period of time</i>" feature is not necessary and even no convenient. What do you think?. <br> -->
	&nbsp; &nbsp; <a href="http://lorrie.cranor.org/" target="_blank">Lorrie Faith Cranor</a> <br>
	&nbsp; &nbsp; <a href="http://www.vote.caltech.edu/" target="_blank">Caltech</a> <br>
	&nbsp; &nbsp; <a href="http://www.notablesoftware.com/evote.html" target="_blank">Electronic Voting</a> <br>
