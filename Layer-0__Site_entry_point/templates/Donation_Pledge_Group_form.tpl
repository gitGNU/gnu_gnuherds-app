...
{/if}
<tr> <td><input type="text" name="WageRank" size="15" maxlength="30" class="required" value="{if $data.WageRan eq ''}0.02{else}{$data.WageRank}{/if}" onblur="if(this.value=='') this.value='0.02';" onfocus="if(this.value=='0.02') this.value='';"> {t}US Dollars (USD){/t}</td> </tr>
