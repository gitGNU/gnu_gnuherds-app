...
{if $smarty.session.ViewPhotoOrLogo eq 'true' }
	<img src="/View_Photo_or_Logo.php?Data=Me&EntityId={$smarty.session.EntityId}" align="left" alt="" style="border: 1; position: relative; left: 0; top: 0;" />
{else}
	<img src="/images/default/Person.png" width="90" height="120" align="left" alt="" style="border: 1; position: relative; left: 0; top: 0;" />
{/if}
</tr>
<tr valign="top">
...
<tr>
<td align="right"><a href="javascript://" onmouseover="popup('{t}Default image size{/t}: 90x120','lightyellow',300);" onmouseout="kill()">{t}Photo{/t}</a> : </td>
...
<td colspan="3"><input type="text" name="Website" size="60" maxlength="255" class="notRequired" value="{$smarty.session.Website}" /></td>
</tr>
<tr><td colspan="4">&nbsp;</td></tr>
<tr><td colspan="4">&nbsp;</td></tr>
<tr><td colspan="4">&nbsp;</td></tr>
