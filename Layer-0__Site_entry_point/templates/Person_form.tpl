...
<form name="personForm" method="post" action="Person.php">

<table align="center">

{if $smarty.session.Logged != '1' }
<tr align="center"> <td colspan="2" align="center" class="mainsection">{t}NEW PERSON{/t}</td> </tr>
<tr> <td colspan="2">&nbsp;</td> </tr>
<tr> <td colspan="2" class="footnote">{t escape=no 1='<a href="http://' 2=$smarty.server.HTTP_HOST 3='/Charter.php#Membership" target="_top">' 4='</a>'}Read the %1%2%3Membership%4 Charter section.{/t}</td> </tr>
{/if}

{if $smarty.session.Logged == '1' }
<tr align="center"> <td colspan="2" align="center" class="mainsection">{t}UPDATE PERSON DATA{/t}</td> </tr>
<tr> <td colspan="2">&nbsp;</td> </tr>
{/if}
...
<tr> <td colspan="2" class="subsection">{t}NAME{/t}</td> </tr>

<tr>
<td align="right"><span class="must">*</span>{t}First name{/t} : </td>
<td> <input type="text" name="FirstName" size="20" maxlength="20" class="required" value="{$smarty.session.FirstName}"> </td>
</tr>
<tr>
<td align="right">{t}Last name{/t} : </td>
<td> <input type="text" name="LastName" size="20" maxlength="20" class="notRequired" value="{$smarty.session.LastName}"> </td>
</tr>
<tr>
<td align="right">{t}Middle name{/t} : </td>
<td> <input type="text" name="MiddleName" size="20" maxlength="20" class="notRequired" value="{$smarty.session.MiddleName}"> </td>
</tr>
...
<tr> <td colspan="2" class="subsection">{t}OTHER INFORMATION{/t}</td> </tr>

<tr>
<td align="right">{t}Year of birth{/t} : </td>
<td colspan="3">
...
{/if}
{html_select_date prefix="Birth" time="$BirthYear" start_year="-100" end_year="-18" display_days=false display_months=false year_empty="" year_extra="class=notRequired"}
</td>
</tr>
...
<td> <input type="text" name="Website" size="60" maxlength="255" class="notRequired" value="{$smarty.session.Website}"> </td>
</tr>
