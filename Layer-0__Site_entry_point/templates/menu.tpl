...
<table style="background-color: {$webpage->theme->menuBGcolor}" cellpadding="0" cellspacing="0" rules="none" border="0">
<tr>
...
<td><img src="{$webpage->theme->borderRightUpImage}" width="2" height="2" align="right" style="border: 0; position: relative; left: 0; top: 0;" /></td>
</tr>
<tr>
<td>
<p>
