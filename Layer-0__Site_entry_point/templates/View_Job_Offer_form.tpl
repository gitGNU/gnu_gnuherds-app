...
{if $smarty.session.ViewPhotoOrLogo eq 'true' }
		<img src="/View_Photo_or_Logo.php?Data=JobOffer&EntityId={$smarty.session.ViewEntityId}" align="left" alt="" style="border: 1; position: relative; left: 0; top: 0;" />
{else}
	...
	{else}
		<img src="/images/default/Company_or_non-profit_Organization.png" width="180" height="120" align="left" alt="" style="border: 1; position: relative; left: 0; top: 0;" />
	{/if}
	<br>
{/if}
</td>
