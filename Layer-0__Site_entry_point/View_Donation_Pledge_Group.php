...
require_once "../Layer-2__Business_logic/content/forms/View_Donation_Pledge_Group_form.php";

$viewDonationPledgeGroupForm = new ViewDonationPledgeGroupForm();

$webPage = new WebPage($viewDonationPledgeGroupForm);
$webPage->processPage();
$webPage->printPage();
?>
