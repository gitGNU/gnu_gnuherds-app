...
require_once "../Layer-2__Business_logic/content/forms/Manage_Job_Offers_form.php";
$manageJobOffersForm = new ManageJobOffersForm();

$webPage = new WebPage($resourcesTheme,$manageJobOffersForm);
$webPage->processPage();
$webPage->printPage();
?>
