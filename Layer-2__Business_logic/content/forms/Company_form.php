...
class CompanyForm
{
	...
	{
		if ( $_POST['delete'] == gettext('Delete me') || $_POST['save'] == gettext('Save') )
	...
	private function checkCompanyForm()
	{
		...
		if ( trim($_POST['Email'])=='' or trim($_POST['Password'])=='' or trim($_POST['CompanyName'])=='' or trim($_POST['CountryCode'])=='' )
		{
			$error = "
