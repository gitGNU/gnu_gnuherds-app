...
class Skills
{
	...
	{
		$sqlQuery = "PREPARE query(integer) AS  SELECT R24_LI_Id,R24_LG_Id,R24_LN_Id FROM R24_Qualification2Skills WHERE R24_Q1_E1_Id=$1;  EXECUTE query('$Id');";
	...
	{
		$sqlQuery = "PREPARE query(integer) AS  SELECT R14_LI_Id,R14_LG_Id,R14_LN_Id FROM R14_JobOffer2Skills WHERE R14_J1_Id=$1;  EXECUTE query('$Id');";
		$result = $this->postgresql->getPostgreSQLObject($sqlQuery,1);
